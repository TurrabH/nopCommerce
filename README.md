﻿nopCommerce: large scale eCommerce solution
===========
...
* nopCommerce leverages .NET Core, MVC, Docker, Redis, Azure Cloud Services including Data Factory, Service Bus, Logic Apps
